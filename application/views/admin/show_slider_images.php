   ...
   <div class="col-lg-9">
      ...
      <table  border="2" class="table table-striped table-hover table-condensed" >
         ...
         foreach ($value->result() as $r)
        {
         ...
         <td><img src="<?php echo site_url('uploads/'.$r->slider_image);?>" height="60" width="110"></td>
         <?php  echo "<td>".$r->image_description."</td>";?>
         <td><a href="<?php echo site_url('admin/con_slider/delete_slider_images/'.$r->id);?>" ><div class="btn btn-danger">DELETE</div></a></td>  
         </tr>
        <?php  $num+=1; } ?>
