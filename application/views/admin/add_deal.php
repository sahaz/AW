...
<h1>ADD DEAL :</h1><br>
<form class="form-horizontal" id="baseform" action="<?php echo site_url('admin/con_todaysdeal/process_deal');?>" method="POST" enctype="multipart/form-data" >
   
    <div class="form-group">
      <label class="col-sm-3 control-label">DEAL Title:</label>
      <div class="col-sm-6">
      <input type="text" name="title" id="title" class="required form-control" />
      </div>
   </div>
